/* @ts-self-types="./zk_prover_wasm.d.ts" */
 ...
 * @returns {string}
 */
export function poseidon_hash2_hex(a_hex, b_hex) {
    let deferred3_0;
    let deferred3_1;
    try {
        ...
        const ret = wasm.poseidon_hash2_hex(ptr0, len0, ptr1, len1);
        deferred3_0 = ret[0];
        deferred3_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @param {string} index_bits
 * @param {string} recipient_hex
 * @returns {string}
 */
export function prove_withdraw_js(pk_bytes, secret_hex, siblings_hex, index_bits, recipient_hex) {
    let deferred6_0;
    let deferred6_1;
    try {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(siblings_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        const ptr3 = passStringToWasm0(index_bits, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len3 = WASM_VECTOR_LEN;
        const ptr4 = passStringToWasm0(recipient_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len4 = WASM_VECTOR_LEN;
        const ret = wasm.prove_withdraw_js(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, ptr4, len4);
        deferred6_0 = ret[0];
        deferred6_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('zk_prover_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
